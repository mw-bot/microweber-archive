...
<link href="<?php   print( $config["url_to_module"]);  ?>plupload/css/plupload.queue.css" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="<?php   print( $config["url_to_module"]);  ?>plupload/js/plupload.full.min.js"></script>
<script type="text/javascript" src="<?php   print( $config["url_to_module"]);  ?>plupload/js/jquery.plupload.queue.min.js"></script>
...
function call_media_manager<? print $call_media_manager; ?>() {
		 ...
		 data1 = {}
   data1.module = 'media/gallery/media_manager';
