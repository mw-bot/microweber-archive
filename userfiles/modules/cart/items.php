...
<br />
<br />
<div id="total"> <span><strong>
  <?php  print (option_get('total_price_text', $params['module_id'])) ? option_get('total_price_text', $params['module_id']) : "Total price";  ?>: </strong></span> <b><span class="cart_items_total"><? print get_cart_total()  ?></span> <?php print option_get('shop_currency_sign') ; ?></b> 
  <br />

  <br />

  <?php  print (option_get('shipping_price_text', $params['module_id'])) ? option_get('shipping_price_text', $params['module_id']) : "Shipping";  ?>: </strong></span> <?php print option_get('shipping') ; ?> <?php print option_get('shop_currency_sign') ; ?> </div>
