...
<div class="content_wide_holder">
 ...
 <center>
 <div class="space_top_5">
<span class="text_13">Supporting us will allow many people around the world to create websites and express easily on the Internet</span> 
</div><div class="space_top_5">
<span><strong class="text_14">Be part of the revolution</strong></span> <a class="blue">Support us now</a> 
</div>
 <div class="space_top_5">
<img src="<? print TEMPLATE_URL ?>img/thank_you.png"  />
</div>
<br />
...
<div class="content_wide_holder_white content_center_home_2">
  <div class="content_center">
    <div class="vid_holder"><img src="<? print TEMPLATE_URL ?>img/video_shot.png"  /></div>
  </div>
...
<div class="content_wide_holder content_wide_holder_bl">
  ...
  <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=225342984166233&amp;xfbml=1"></script><fb:like href="https://www.facebook.com/Microweber" send="true" width="400" show_faces="false" font=""></fb:like>
          <div class="space_top_5">
            <a href="http://twitter.com/Microweber" class="twitter-follow-button">Follow @Microweber</a>
            <script src="http://platform.twitter.com/widgets.js" type="text/javascript"></script></div>
    </td>
    <td><a><img border="0" src="<? print TEMPLATE_URL ?>img/support_us1.png"  /></a></td>
  </tr>
</table>
</div>
