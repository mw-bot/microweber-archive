...
$dashboard_following = CI::model('users')->realtionsGetFollowersIdsForUser ( $aUserId = false,  $is_special, $query_options );
$query_options ['get_count'] = true;

$query_options ['items_per_page'] = false;
$dashboard_following_count = CI::model('users')->realtionsGetFollowersIdsForUser ( $aUserId = false,  $is_special, $query_options );
...
$dashboard_followers = CI::model('users')->getFollowers(false, $only_ids = true);
