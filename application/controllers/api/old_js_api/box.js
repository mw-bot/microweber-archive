...
mw.box = {
  ...
  alert:function(html, id){
        ...
        mw.box.html({html:'<table style="height:130px;width:100%"><tr><td align="center" valign="middle">' + html + ok + '</td></tr></table>', width:380, height:165,id:id!=undefined?id:(Math.ceil(Math.random() * 999999) - 1)});
  }
}
