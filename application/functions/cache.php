 ...
 * 
 * @param  	string	$cache_group	cache group (default is 'global') - this is the subfolder in the cache dir.
 * @return boolean
 * @author	Peter Ivanov
 * @since Version 1.0
  */
 ...
 * 
 * 
 * @param  	string	$cache_id	the id of the cache
 * @param  	string	$cache_group	cache group (default is 'global') - this is the subfolder in the cache dir.
 *
 * @return string
 * @author	Peter Ivanov
 ...
 * 
 * @param  	mixed	$data_to_cache	give me your data
 * @param  	string	$cache_id	the id of the cache, you must define it because you will use it later to load the file. 
 * @param  	string	$cache_group	cache group (default is 'global') - this is the subfolder in the cache dir.
 *
 * @return boolean 
 * @author	Peter Ivanov
...
/**
 * @desc  Writes the cache file in the CACHEDIR directory.
 * @param  	string	$cache_id	the id of the cache
 * @param  	string	$content	the text content for the file, must be a string, if you want to store object or array, please use the cache_store_data() function
 * @param  	string	$cache_group	cache group (default is 'global') - this is the subfolder in the cache dir.
 *
 * @return string
 * @author	Peter Ivanov
