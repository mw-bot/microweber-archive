<script type="text/javascript">
    ...
    //	empty_column_placeholder : '<div class="ui-state-highlight ui-sortable-placeholder"><span>Please drag items here 1</span></div>',
    	...
    	//handles
    	sorthandle_row : "<div class='mw-sorthandle mw-sorthandle-row'><div class='columns_set'></div><div class='mw-sorthandle mw-sorthandle-row'><div class='mw_row_delete mw.edit.delete_element'>&nbsp;</div></div>";
    	 ,
