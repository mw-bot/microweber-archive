...
?>
    ...
    <script type="text/javascript">
        ...
        function openKCFinder(field) {
            ...
            window.open('<?php   print( ADMIN_STATIC_FILES_URL);  ?>js/tiny_mce/plugins/kcfinder/browse.php?type=images&dir=images/public&custom=true', 'kcfinder_textbox', 'status=0, toolbar=0, location=0, menubar=0, directories=0, ' + 'resizable=1, scrollbars=0, width=800, height=600');
        }
                    ...
                    success: function (data) {
                        ...
                        if (only_preview == undefined || only_preview == false) {
                            jQuery.each(data, function (i, item) {
                                ...
                                <?
                                if (url_param('layout_editor') != 'yes'): ?> jQuery("#" + data[i].page_element_id).html(data[i].page_element_content); <? endif; ?>
    ...
    <script type="text/javascript">
        function replace_content_from_history($history_file_base64_encoded) {
            ...
            load_field_from_history_file('<? print $id ?>', $history_file_base64_encoded); <? endif; ?>
    ...
    <div id="mw-layout-edit-site-previe-button" class="fixed-position"></div>
        ...
        <div id="mw-layout-edit-site-top-bar-l">
            <div id="mw-layout-edit-toolbar-top-container">
                ...
                <div id="mw_toolbar_tabs">
                    <ul>
                        <li>
                            <a href="#mw_toolbar_tabs-2">Modules</a>
                        </li>
                        <li>
                            <a href="#mw_toolbar_tabs-3">Layouts</a>
                        </li>
                        <li>
                            <a href="#mw_toolbar_tabs-5">Page settings</a>
                        </li>
                        <li>
                            <a href="#mw_toolbar_tabs-7">Help</a>
                        </li>
                        <li>
                            <a href="#mw_css_editor">Style editor</a>
                        </li>
                    </ul>
...
-->
    ...
    <div id="mw-layout-edit-footer-bar">
        ...
        <div class="mw-layout-edit-site-bar-r">
            <span class="mw-layout-edit-curent-row-element"></span>
            <div id="make_cols_template">Make cols:
            ...
            <span class="mw-layout-edit-curent-element"></span>
            <a onclick="mw_delete_element()">x</a>
        </div>
    </div>
    <div id="mw-temp"></div>
    <div id="ContentSave">
